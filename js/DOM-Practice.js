...
//     let html = '<div class= "col-5 cards"><h2> "' + movie.title + '" </h2><img src="' + movie.image + '"> <p>"' + movie.release + '"</p><p>"' + movie.gross + '"</p></div>';
//     return html;
// }
//
...
//
// let middle = document.querySelector('.row');
// middle.innerHTML = createColumns(movies);
